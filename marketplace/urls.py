...
urlpatterns = [
    ...
    path('product/<str:product_id>/', views.product_detail_page, name='product-detail'),
    ...
    path('api/chat/messages/', views.get_chat_messages_json, name='api-chat-messages'),
    path('api/chat/send/', views.send_chat_message_json, name='api-chat-send'),
    path('api/chat/contacts/', views.get_chat_contacts_json, name='api-chat-contacts'),
    ...
    path('api/cart/checkout/', views.checkout_cart_json, name='api-cart-checkout'),
    path('api/product/<str:product_id>/download/', views.download_product_api, name='api-product-download'),
